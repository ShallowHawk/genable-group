    ...
    <section class="py-24 lg:py-32 bg-white">
      <div class="container-section text-center">
        <div class="max-w-3xl mx-auto">
          ...
          <!-- 错误信息 -->
          <div class="mb-12">
            <h2 class="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">页面未找到</h2>
            <p class="text-xl text-gray-600 mb-6">抱歉，您访问的页面不存在或已被移动。</p>
            <p class="text-gray-500">请检查URL是否正确，或返回首页继续浏览。</p>
          </div>

          <!-- 操作按钮 -->
          <div class="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <BaseButton as="router-link" to="/" variant="primary" size="lg">
              <Icon name="home" size="sm" class="mr-2" />
              返回首页
            </BaseButton>

            <BaseButton @click="goBack" variant="outline" size="lg">
          ...
          <div class="border-t border-gray-200 pt-12">
            <h3 class="text-lg font-semibold text-gray-900 mb-6">您可能感兴趣的页面</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                <div
                  class="w-12 h-12 bg-primary-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-primary-200"
                >
